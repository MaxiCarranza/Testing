...
class test_01(unittest.TestCase):
    ...
    def test_001(self):
        ...
        administracion = self.driver.find_element_by_xpath("//*[contains(text(), 'Administrar')]")
        administracion.click()
        feriadoMenu = self.driver.find_element_by_link_text('Administrar')
        feriadoMenu.click()
        feriado = self.driver.find_element_by_xpath('//*[@id="menu"]/ul/li[1]/a/span[2]')
        feriado.click()
        #anio = self.driver.find_element_by_id('year')
        anio = self.driver.find_element_by_name('year')
        anio.click()
        anio.send_keys("2020")
        #time.sleep()
        #usuario.send_keys("2020")
        #usuario.click()
        #time.sleep(1)
